...
function getPopupTxt(aCourse){
    ...
    if(aCourse =="course0week0"){
        ...
        _popText = "<p></p><ol> " +
            ...
            "<li>Apply various data types, basic operators, Python functions, and control structures (if, for, while) and arguments to understand the data\n</li> " +
            "<li>Explore the data structures, data types, tuples, lists, and sets to organise and group data\n</li> " +
            "<li>Create variables and assign values to the variables (multiple assignments)\n</li> " +
...
console.log(document.getElementsByClassName('module-sequence-footer-button--previous')[0]);
var acc = document.getElementsByClassName("accordion");
var i;
for (i = 0; i < acc.length; i++) {
    acc[i].addEventListener("click", function() {
