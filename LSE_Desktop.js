...
function getPopupTxt(aCourse){
    ...
    // Course 2
        ...
        _popText = "<p></p><ol> " +
            ...
            "<li>Use the apply() method to transform data and write functions to clean data</li> " +
        ...
        _popText = "<p></p><ol> " +
            ...
            "<li>Describe how ethical practices are related to working with Python.</li> " +
            "</ol>";
    }
    // Course 3
        ...
        _popText = "<p></p><ol> " +
            "<li>Describe how predictive analytics and business forecasting techniques are used to forecast future outcomes</li> " +
            "<li>Differentiate between simple and multiple linear regression techniques, and determine their suitability within specific business contexts\n</li> " +
            "<li>Solve a simple linear regression problem using the line of best fit to make inferences about parameters for a specific business scenario</li> " +
            "<li>Create linear regression models using Python to predict outcomes for a specific business scenario.</li> " +
            "</ol>";
    }
    else if(aCourse =="course3week2"){
        _popText = "<p></p><ol> " +
            "<li>Differentiate between linear and logistic regression analysis, and determine their suitability to predict future outcomes </li> " +
            "<li>Apply clustering and classification approaches to predict future outcomes </li> " +
            "<li>Create and apply classification algorithms (decision trees and random forests), using different types of variables, to determine the best predictive modelling technique to solve a business problem\n</li> " +
            "<li>Build and apply a k-means clustering model to manage and classify data to predict future outcomes </li> " +
            "<li>Evaluate predictive modelling techniques and select a suitable method based on use cases</li> " +
            "</ol>";
    }
    else if(aCourse =="course3week3"){
        _popText = "<p></p><ol> " +
            "<li>Execute text analytics to infer business outcomes</li> " +
            "<li>Use a natural language programming based machine learning approach to create business value from textual data</li> " +
            "<li>Perform sentiment analysis on data from social media platforms and surveys, using Python, to validate market opportunities and gain customer insights</li> " +
            "<li>Create surveys to collect high-quality data for data analysis</li> " +
            "</ol>";
    }
        ...
        _popText = "<p></p><ol> " +
            "<li>Apply advanced R functions to perform data wrangling.\n</li> " +
            "<li>Apply descriptive statistics and inferential statistics to deduce business insights in R.</li> " +
            "<li>Prepare advanced visualisations to explore and analyse data sets.\n</li> " +
            "</ol>";
    }
